...
const isOpen = true
fnCreate(common, isOpen)
fnCreate(jobSchedule, isOpen)
fnCreate(oss, isOpen)
fnCreate(sysConfig, isOpen)
fnCreate(sysLog, isOpen)
fnCreate(sysMenu, isOpen)
fnCreate(sysRole, isOpen)
fnCreate(sysUser, isOpen)
